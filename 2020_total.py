...
required_cols = ["dms_mode", "sctg2", "tons_2020"]
...
# 3. 2020년 트럭 운송 품목 전체 가로 막대 그래프
target_year_col = "tons_2020"
...
ax.set_title("2020년 트럭 운송 품목별 물동량 (전체)", fontweight="bold", fontsize=16)
...
st.write("- `tons_2020`: 2020년 트럭 운송 물동량 합계. 단위는 `thousand tons`(천 톤)이며 막대의 x축입니다.")
st.write("- 트럭 추출 기준: `dms_mode == 1` 인 행만 사용합니다.")
st.write("- 결측치 제거 기준: `dms_mode`, `sctg2`, `tons_2020` 중 하나라도 NaN이면 해당 행을 제외합니다.")
