...
ax.set_title("2024년 트럭 운송 품목별 물동량 (전체)", fontweight="bold", fontsize=16)
...
st.write("- 결측치 제거: `dms_mode`, `sctg2`, `tons_2024` 중 하나라도 NaN이면 해당 행을 제외한 뒤 트럭만 필터링합니다.")
